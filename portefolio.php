...
?>
		<main class='content'>
			...
			<div class='content2'>
				<figure id='resize'>
					<a href='projects/<?php echo $url1; ?>' class='slide'><img id='slide1' src='photo/<?php echo $array_picture[$id_photo1]; ?>' alt=''></a>
					<a href='projects/<?php echo $url2; ?>' class='slide'><img id='slide2' src='photo/<?php echo $array_picture[$id_photo2]; ?>' alt=''></a>
					<a href='projects/<?php echo $url3; ?>' class='slide'><img id='slide3' src='photo/<?php echo $array_picture[$id_photo3]; ?>' alt=''></a>
				</figure>
			</div>
			<section>
